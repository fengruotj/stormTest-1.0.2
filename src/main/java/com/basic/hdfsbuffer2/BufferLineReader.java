...
public class BufferLineReader {
    ...
    public BufferLineReader(ByteBuffer byteBuffer) {
        this(byteBuffer, 65536);
    }

    public BufferLineReader(ByteBuffer byteBuffer, int bufferSize) {
    ...
    public BufferLineReader(ByteBuffer byteBuffer, Configuration conf) throws IOException {
        this(byteBuffer, conf.getInt("io.file.buffer.size", 65536));
    }

    public BufferLineReader(ByteBuffer byteBuffer, byte[] recordDelimiterBytes) {
        this.bufferSize = 65536;
        this.bufferLength = 0;
        this.bufferPosn = 0;
        this.buffer = new byte[this.bufferSize];
    ...
    public BufferLineReader(ByteBuffer byteBuffer, int bufferSize, byte[] recordDelimiterBytes) {
        this.bufferSize = 65536;
        this.bufferLength = 0;
        this.bufferPosn = 0;
        this.byteBuffer=byteBuffer;
    ...
    public BufferLineReader(ByteBuffer byteBuffer, Configuration conf, byte[] recordDelimiterBytes) throws IOException {
        this.bufferSize = 65536;
        this.bufferLength = 0;
        this.bufferPosn = 0;
        this.bufferSize = bufferSize;
