...
import com.basic.storm.spot.FSDataInputSpout;
 ...
 * 提交stormtopology任务 storm jar stormTest-1.0.2-SNAPSHOT.jar com.basic.storm.topology.HDFSDataInputWordCountTopology hdfswordcount 8 16 /user/root/flinkwordcount/input/resultTweets.txt
 */
public class HDFSDataInputWordCountTopology {
    public static final String HDFS_SPOUT_ID ="hdfs-datainputStream-spout";
    ...
    public static void main(String[] args) throws IOException, InterruptedException, InvalidTopologyException, AuthorizationException, AlreadyAliveException, AuthorizationException {

        FSDataInputSpout fsDataInputSpout= new FSDataInputSpout(args[3]).withOutputFields("word");
        ...
        builder.setSpout(HDFS_SPOUT_ID,fsDataInputSpout);
