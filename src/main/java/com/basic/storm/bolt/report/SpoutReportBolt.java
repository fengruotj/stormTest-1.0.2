...
import com.basic.storm.task.SpoutTupleCountTask;
...
public class SpoutReportBolt extends BaseRichBolt {
    ...
    public void execute(Tuple tuple) {
        logger.info("------------SpoutReportBolt execute------------");
        ...
        SpoutTupleCountTask spoutTupleCountTask=new SpoutTupleCountTask(timestamp,tupplecount);
        executor.execute(spoutTupleCountTask);
//        Timestamp timestamp=new Timestamp(currentTimeMills);
//        DataBaseUtil.insertSpoutTupleCount(timestamp,tupplecount);
