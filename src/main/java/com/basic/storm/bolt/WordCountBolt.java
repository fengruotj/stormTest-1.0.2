...
public class WordCountBolt extends BaseRichBolt{
    ...
    public void prepare(Map map, TopologyContext topologyContext, OutputCollector outputCollector) {
        logger.info("------------ WordCountBolt prepare------------");
    ...
    public void execute(Tuple tuple) {
        //logger.info("------------ WordCountBolt execute------------");

        //将数据写入文件
        tupplecount++;
        alltupplecount++;

        delaystartTimemills=tuple.getLongByField("timeinfo");  //屏蔽处理延迟代码
        ...
        //logger.info("------------ WordCountBolt emit wordcounStream------------"+" word:"+word+" count:"+counts);
        ...
        if(!resultQueue.isEmpty()){
            ...
            if(poll!=null){
                ...
                logger.info("------------ WordCountBolt emit tupplecountstream------------"+" time:"+poll.getSystemMills()+" tupplecount:"+poll.getTupplecount());
            }
